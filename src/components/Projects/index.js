                  ...
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    >
                      <Tab.Pane eventKey="first">
                        <Row>
                          <p>
                            <Markup content={t("project.memotest.desc")} />
                          </p>
                          <Row
                            style={{
                              alignItems: "center",
                          ...
                          >
                            <Col size={6} sm={6} md={3}>
                              <button>
                                <span>
                                  <a
                                    href={process.env.REACT_APP_MEMOTEST_SOURCE}
                                  >
                                    {t("common.source")}
                                  </a>
                                </span>
                            ...
                            <Col size={6} sm={6} md={3}>
                              <button>
                                <span>
                                  <a
                                    href={process.env.REACT_APP_MEMOTEST_BUILD}
                                  >
                                    {t("common.download")}
                                  </a>
                                </span>
                      ...
                      <Tab.Pane eventKey="second">
                        <Row>
                          <p>
                            <Markup content={t("project.pokedex.desc")} />
                          </p>
                          <Row
                            style={{
                              alignItems: "center",
                          ...
                          >
                            <Col size={6} sm={6} md={3}>
                              <button>
                                <span>
                                  <a
                                    href={process.env.REACT_APP_POKEDEX_SOURCE}
                                  >
                                    {t("common.source")}
                                  </a>
                                </span>
                            ...
                            <Col size={6} sm={6} md={3}>
                              <button>
                                <span>
                                  <a href={process.env.REACT_APP_POKEDEX_BUILD}>
                                    {t("common.build")}
                                  </a>
                                </span>
                                <Terminal size={25} />
